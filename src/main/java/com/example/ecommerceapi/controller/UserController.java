...
import com.example.ecommerceapi.dto.user.ChargePointRequest;
...
public class UserController {
    ...
    public ResponseEntity<Map<String, Object>> getPointBalance(
        ...
        Integer balance = userService.getPointBalance(userId);
    ...
    public ResponseEntity<List<PointResponse>> getPointHistory(
        ...
        List<PointResponse> history = userService.getPointHistory(userId);
    ...
    public ResponseEntity<PointResponse> chargePoint(
        ...
        PointResponse point = userService.chargePoint(userId, request.getAmount());
